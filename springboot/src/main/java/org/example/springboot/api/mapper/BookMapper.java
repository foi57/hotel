...
public interface BookMapper {
    ...
    @Select("SELECT book.id,hotel.name,book.timeStart,book.timeEnd,book.arrivalTime,book.price,room.room_name,room.room_count,book.bookTime,book.state,book.user_id,book.room_id from book,room,hotel where book.user_id=#{userId} and room.id=book.room_id and hotel.id=room.hotel_id")
